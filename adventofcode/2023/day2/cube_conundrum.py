...
# Function to check if a game is possible with the given cube constraints
...
# Initialize a variable to store the sum of IDs of possible games
possible_games_sum = 0

# Check each game and update the sum if the game is possible
for game in games:
